    ...
    document.startViewTransition(
      () => {
        ...
        for (const film of tableauFilms) {
          ...
          // console.log("Objet articleFilm : ", articleFilm);

          // Ajouter la propriété CSS viewTransitionName avec une valeur
          // différente pour chaque film
          articleFilm.style.viewTransitionName = "film" + film.id;
